...
class M2E_MultichannelConnect_Model_Magento_Quote_Store_Configurator
{
    /** @var $_quote Mage_Sales_Model_Quote */
    protected $_quote = null;

    /** @var $proxy M2E_MultichannelConnect_Model_Order_ProxyObject */
    ...
    public function init(Mage_Sales_Model_Quote $quote, M2E_MultichannelConnect_Model_Order_ProxyObject $proxyOrder)
    {
    ...
    public function getShippingTaxClassId()
    {
        ...
        $storeShippingTaxRate = Mage::getSingleton('MultichannelConnect/Magento_Tax_Helper')
        ...
        if ($proxyOrder->isTaxModeNone()
            ...
            return M2E_MultichannelConnect_Model_Magento_Quote_Item::TAX_CLASS_ID_NONE;
        }
    ...
    protected function getDefaultCustomerGroupId()
    {
        ...
        $currentCustomerTaxClass = Mage::getSingleton('tax/calculation')->getDefaultCustomerTaxClass(
            $this->getStore()
        );
