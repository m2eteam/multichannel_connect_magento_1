...
class M2E_MultichannelConnect_Model_Magento_Tax_Rule_Builder
{
    const TAX_CLASS_NAME_PRODUCT   = 'M2E Cloud Connector Product Tax Class';
    const TAX_CLASS_NAME_CUSTOMER  = 'M2E Cloud Connector Customer Tax Class';
    const TAX_CLASS_NAME_SHIPPING  = 'M2E Cloud Connector Shipping Tax Class';

    const TAX_RATE_CODE_PRODUCT    = 'M2E Cloud Connector Tax Rate';
    const TAX_RULE_CODE_PRODUCT    = 'M2E Cloud Connector Tax Rule';

    const TAX_RATE_CODE_SHIPPING   = 'M2E Cloud Connector Shipping Tax Rate';
    const TAX_RULE_CODE_SHIPPING   = 'M2E Cloud Connector Shipping Tax Rule';
